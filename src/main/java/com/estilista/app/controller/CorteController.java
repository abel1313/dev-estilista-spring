...
public class CorteController extends BaseControllerImpl<Corte, CorteServiceImpl>{
    ...
    public ResponseEntity<ResponseGeneric<Page<CorteDto>>> getAllCortePage(@PathVariable final int page, @PathVariable final int size) {
        ResponseGeneric<Page<CorteDto>> responseGeneric = new ResponseGeneric<>();
        try{
